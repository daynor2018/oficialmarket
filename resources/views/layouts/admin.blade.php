                    ...
                    <ul class="menu">
                        <li>
                            <a href="javascript:void(0);">
                                ...
                                <div class="menu-info">
                                    <h4>12 productos para promoción</h4>
                                    <p>
                                        <i class="material-icons">access_time</i> hace 14 minutos
                                    </p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);">
                                ...
                                <div class="menu-info">
                                    <h4> 4 ventas realizadas con exito</h4>
                                    <p>
                                        <i class="material-icons">access_time</i> ultima venta hace 20 minutos
                                    </p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);">
                                ...
                                <div class="menu-info">
                                    <h4><b>Nancy Doe</b> ha descativado su cuenta</h4>
                                    <p>
                                        <i class="material-icons">access_time</i> 3 horas atras
                                    </p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);">
                                ...
                                <div class="menu-info">
                                    <h4><b>Nancy</b> cambio su contraseña</h4>
                                    <p>
                                        <i class="material-icons">access_time</i> 2 horas atras
                                    </p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);">
                                ...
                                <div class="menu-info">
                                    <h4><b>John</b> realizo una encuesta</h4>
                                    <p>
                                        <i class="material-icons">access_time</i> 4 horas atras
                                    </p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0);">
                                ...
                                <div class="menu-info">
                                    <h4><b>John</b> consiguio un descuento</h4>
                                    <p>
                                        <i class="material-icons">access_time</i> 3 horas atras
                                    </p>
                                </div>
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                ...
                                <div class="menu-info">
                                    <h4>Configuracion actualizada</h4>
                                    <p>
