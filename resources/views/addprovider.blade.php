...
@section('title')
<title>Agregar | Proveedor | "KIOS"</title>
@endsection
@section('css')
<!-- Bootstrap Core Css -->
        ...
        <div class="card">
            <div class="header">
                <h2>
                    ...
                    <small>Por favor ingrese todos los datos requeridos</small>
                </h2>
            ...
            <div class="body">
               <form action="{{route('registerprovider')}}" method="POST" enctype="multipart/form-data">
               @csrf
                <div class="row clearfix">
                    <div class="col-sm-3">
                        <div class="form-group">
                           <h5 class="text-center m-t-0">Imagen para el proveedor</h5>               
